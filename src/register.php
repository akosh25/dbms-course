...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($felhasznalonev) || empty($email) || empty($jelszo) || empty($jelszo_ujra)) {
        ...
        // email ellenőrzése
        $check_sql = "SELECT COUNT(*) AS CNT FROM Felhasznalo WHERE LOWER(email) = LOWER(:email)";
    ...
    $error_message = "Hiba történt a regisztráció során: " . $e['message'];
}
